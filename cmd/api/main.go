...
func main() {
	...
	flag.Func("cors-trusted-origins", "Truste CORS origins (space separated)", func(s string) error {
	...
	// Publish a new "version" variable in the expvar handler containing the application version number
